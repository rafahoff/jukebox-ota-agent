...
Auto-update do próprio agente: **fora de escopo v1** (provisionamento manual via `ota_deploy_to_pi.ps1`). Roadmap pós-v1: `TODO.MD` § 3 · [[BRAINSTORM_AUTO_UPDATE_AGENTE]] · [JUK-83](https://linear.app/jukeeo/issue/JUK-83).
